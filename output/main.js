...
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.registerPlugin(gsap_TextPlugin__WEBPACK_IMPORTED_MODULE_3__.TextPlugin);
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to('.navbar .navbar-brand', { duration: 1, delay: 1.2, text: 'Ardit' });
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(' .jumbotron span:nth-child(3)', { duration: 1.2, delay: 1.7, text: 'Web developer' });
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.from('.jumbotron img', { duration: 1, y: -100, opacity: 0, ease: 'bounce' });
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.from('.navbar .nav-item', { duration: 1.3, translateX: 250, ease: 'power2' });
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.from('.navbar button', { duration: 1.3, translateX: 250, ease: 'power2' });
